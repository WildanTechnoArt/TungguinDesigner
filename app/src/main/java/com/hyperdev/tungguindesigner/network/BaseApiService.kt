...
interface BaseApiService {
    ...
    fun getWithdrawHistori(
        @Header("Authorization") authHeader: String,
        @Header("Accept") accept: String,
        @Query("page") page: Int
    ): Flowable<WithdrawHisResponse>

    @GET("designer/wallet")
    fun getTransactionHistori(
        @Header("Authorization") authHeader: String,
        @Header("Accept") accept: String,
        @Query("page") page: Int
    ...
    fun getTestimoniHistori(
        @Header("Authorization") authHeader: String,
        @Header("Accept") accept: String,
        @Query("page") page: Int
    ): Flowable<TestimoniResponse>
