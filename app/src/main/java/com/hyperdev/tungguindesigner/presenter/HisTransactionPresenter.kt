...
class HisTransactionPresenter(private val view: TransactionHisView.View,
                              private val transaction: TransactionHisRepositoryImpl,
                              private val scheduler: SchedulerProvider) : TransactionHisView.Presenter{
    ...
    override fun getHistoriTransaction(token: String, context: Context, page:Int) {
        ...
        compositeDisposable.add(transaction.getTransactionHistori(token, "application/json", page)
